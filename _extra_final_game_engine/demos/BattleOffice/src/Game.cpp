...
void Game::Start()
{
  ...
  _pOfficeImage = new Image(renderer, "res/Office.png");
  _pTargetImage = new Image(renderer, "res/Target.png", &scTrans);
  _pPowImage = new Image(renderer, "res/Pow.png", &scTrans);
  _pGuyImages[0] = new Image(renderer, "res/Guy1.png", &scTrans);
  _pGuyImages[1] = new Image(renderer, "res/Guy2.png", &scTrans);
  _pGuyImages[2] = new Image(renderer, "res/Guy3.png", &scTrans);
  _pGuyImages[3] = new Image(renderer, "res/Guy4.png", &scTrans);
  _pGuyImages[4] = new Image(renderer, "res/Guy5.png", &scTrans);
  _pSmallGuyImage = new Image(renderer, "res/SmallGuy.png", &scTrans);
  ...
  rcBounds.x = 385;
  _pGuySprites[4] = new Sprite(_pGuyImages[4], rcBounds, BA_WRAP);
...
void Game::End()
{
  ...
  // Cleanup the bitmaps
  delete _pOfficeImage;
  delete _pTargetImage;
  delete _pPowImage;
  for (int i = 0; i < 5; i++)
    delete _pGuyImages[i];
  delete _pSmallGuyImage;
...
void Game::Paint()
{
  ...
  _pOfficeImage->Draw(renderer, 0, 0);
  ...
  for (int i = 0; i < _iMisses; i++)
    _pSmallGuyImage->Draw(renderer,
			   389 + (_pSmallGuyImage->GetWidth() * i),
			   359);

  // Draw the game over message, if necessary
  if (_bGameOver)
    _pGameOverImage->Draw(renderer, 120, 110);
