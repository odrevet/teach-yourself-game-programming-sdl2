...
void Game::Start()
{
  ...
  _pTiles[0] = new Image(renderer, "res/TileBlank.png");
  _pTiles[1] = new Image(renderer, "res/Tile1.png");
  _pTiles[2] = new Image(renderer, "res/Tile2.png");
  _pTiles[3] = new Image(renderer, "res/Tile3.png");
  _pTiles[4] = new Image(renderer, "res/Tile4.png");
  _pTiles[5] = new Image(renderer, "res/Tile5.png");
  _pTiles[6] = new Image(renderer, "res/Tile6.png");
  _pTiles[7] = new Image(renderer, "res/Tile7.png");
  _pTiles[8] = new Image(renderer, "res/Tile8.png");
