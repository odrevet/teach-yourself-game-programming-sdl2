...
void Game::Start()
{
  ...
  _pGroundImage = new Image(renderer, "res/Ground.png", &scTrans);
  _pTargetImage = new Image(renderer, "res/Target.png", &scTrans);
  _pCityImage = new Image(renderer, "res/City.png", &scTrans);
  _pMeteorImage = new Image(renderer, "res/Meteor.png", &scTrans);
...
void Game::End()
{
  ...
  // Cleanup the bitmaps
  delete _pGroundImage;
  delete _pTargetImage;
  delete _pCityImage;
  delete _pMeteorImage;
